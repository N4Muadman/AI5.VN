...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            {{-- <div class="m-header" style="height: 250px !important">
                <a href="" class="b-brand text-primary">
                    <img src="{{ asset('adminAssets/images/logo.jpg') }}" class="img-fluid" width="250px"
                        alt="logo">
                </a>
            </div> --}}
            <div class="navbar-content">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 me-2">
                                <h6 class="mb-0">{{ Auth::user()->name }}</h6><small>Vai trò:
                                    Người quản trị</small>
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a class="pc-link" href="{{ route('banners.index') }}">Quản lý banners</a></li>
                    </li>
                    <li class="pc-item">
                        <a class="pc-link" href="{{ route('landing-pages.index') }}">Quản lý khóa học</a></li>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer class="pc-footer">
        <div class="footer-wrapper container-fluid">
            <div class="row">
                <div class="col my-1">
                    <p class="m-0"><a href="https://gvcvina.vn/" target="_blank">C09 &#9829;</a></p>
                </div>
            </div>
        </div>
    </footer>
